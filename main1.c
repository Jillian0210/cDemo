...
void test01() {
    ...
    //由此可知上面的结论： sizeof返回的占用空间大小是为这个变量开辟的大小，而不只是它用到的空间
    int a = 1000000;
    printf("len:%llu\n", sizeof(a));
    printf("len:%llu\n", sizeof(int));
    printf("len:%llu\n", sizeof a);
